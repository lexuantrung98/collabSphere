...
namespace CommunicationService.Services
{
    ...
    public class ClassDto { public int Id { get; set; } public string Code { get; set; } = ""; public string Name { get; set; } = ""; public int SubjectId { get; set; } public string SubjectCode { get; set; } = ""; public string SubjectName { get; set; } = ""; public string LecturerId { get; set; } = ""; }
    public class GroupDto { public string Id { get; set; } public string Name { get; set; } public string ClassId { get; set; } public string? SubjectCode { get; set; } }
    ...
    public class MockDataService
    {
        ...
        {
            new ClassDto { Id = 1, Name = "Lớp .NET Core", LecturerId = "gv-01" },
            new ClassDto { Id = 2, Name = "Lớp Java", LecturerId = "gv-02" }
        };
