      ...
      <div style={{ 
        ...
        <div style={{ padding: 24, flex: 1 }}>
          ...
          <Link to="/staff/subjects" style={{ textDecoration: "none" }}>
            <div style={{ 
              padding: "12px 16px", 
              background: isActive('subjects') ? "#e7f3ff" : "transparent",
              color: isActive('subjects') ? "#18b8f2" : "#666",
              borderRadius: 8, 
              fontWeight: isActive('subjects') ? "bold" : "normal",
              cursor: "pointer",
              marginBottom: 8
            }}>
              📚 Quản lý Môn học
          ...
          <Link to="/staff/syllabus" style={{ textDecoration: "none" }}>
            <div style={{ 
              padding: "12px 16px", 
              background: isActive('syllabus') ? "#e7f3ff" : "transparent",
              color: isActive('syllabus') ? "#18b8f2" : "#666",
              borderRadius: 8, 
              fontWeight: isActive('syllabus') ? "bold" : "normal",
              cursor: "pointer",
              marginBottom: 8
            }}>
              📖 Quản lý Giáo trình
          ...
          <Link to="/staff/enrollment" style={{ textDecoration: "none" }}>
            <div style={{ 
              padding: "12px 16px",
              background: isActive('enrollment') ? "#e7f3ff" : "transparent",
              color: isActive('enrollment') ? "#18b8f2" : "#666",
              borderRadius: 8,
              fontWeight: isActive('enrollment') ? "bold" : "normal",
              cursor: "pointer",
              marginBottom: 8
            }}>
              👥 Quản lý Sinh viên
