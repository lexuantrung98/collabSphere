    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#f5f5f5', margin: 0, padding: 0 }}>
      ...
      <div style={{
        ...
        <div style={{ padding: '24px 20px', borderBottom: '1px solid #f0f0f0' }}>
          ...
          <p style={{ margin: '5px 0 0 0', color: '#8c8c8c', fontSize: 12 }}>Admin Panel</p>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 14, fontWeight: 600, marginBottom: 4, color: '#667eea' }}>👑 Admin</div>
          <div style={{ fontSize: 12, color: '#595959', marginTop: 4 }}>{userFullName || 'Administrator'}</div>
        </div>
        ...
        <div style={{ flex: 1, padding: '0 12px', overflowY: 'auto' }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 11, color: '#262626', marginBottom: 8 }}>📊 QUYỀN HẠN ADMIN</div>
