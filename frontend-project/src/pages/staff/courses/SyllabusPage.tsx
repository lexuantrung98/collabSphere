    ...
    <div>
      <div style={{ marginBottom: 30 }}>
        ...
        <p style={{ color: "#666", margin: "5px 0 0 0" }}>
          Upload và quản lý giáo trình cho các môn học
        </p>
      </div>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
                  <tr style={{ borderBottom: '2px solid #f0f0f0' }}>
                    ...
                    <th style={{ padding: 12, textAlign: 'left', color: '#666' }}>Người upload</th>
                    <th style={{ padding: 12, textAlign: 'left', color: '#666' }}>Ngày giờ upload</th>
                    ...
                    <tr key={syllabus.id} style={{ borderBottom: '1px solid #f0f0f0' }}>
                      ...
                      <td style={{ padding: 12, textAlign: 'right', display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
                        <button
                          ...
                          style={{ padding: '6px 12px', background: '#52c41a', color: '#fff', border: 'none', borderRadius: 4, cursor: 'pointer' }}
                        >
                          Tải xuống
                        </button>
                        <button
